...
//    private ComboBox<String> conceptComboBox;
    ...
    private final EventBus eventBus = toolBox.eventBus();
...
//                                String primaryName = concept.primaryName();
...
//                                        eventBus.publish(new UpdateAnnotationCmd(oldA, newA));
//                                    });
//                                //}
//                            }));
//                }
...
//                .get()
//                .namesService()
//                .listNames(10000, 0) // HACK. Hardwaries in number of concepts
//                .thenAccept(page -> {
//                    var names = page.content();
...
//    }
    ...
    public static AnnotationEditorPaneController newInstance() {
        final ResourceBundle bundle = Initializer.getToolBox().i18n();
